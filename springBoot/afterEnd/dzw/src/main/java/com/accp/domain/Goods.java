...
public class Goods {
    ...
    public void setCentreclassify(String centreclassify) {
    ...
    public String getYieldiy() {
        return yieldiy;
    }

    public void setYieldiy(String yieldiy) {
    ...
    public String getPricean() {
        return pricean;
    }

    public void setPricean(String pricean) {
        this.pricean = pricean;
    }
